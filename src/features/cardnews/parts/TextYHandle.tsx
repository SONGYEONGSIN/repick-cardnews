 ...
 *
 * 글 덩어리 안에 놓여 오른쪽 모서리에 걸터앉는다 — 자리를 클래스로만 잡아 글을 옮겨도
 * 따라오고, 인라인 style 을 하나도 더 쓰지 않는다.
 *
...
export function TextYHandle({
  ...
  return (
    <button
      ...
      className={`pointer-events-auto absolute right-0 top-1/2 flex h-11 w-11 -translate-y-1/2 translate-x-1/2 cursor-ns-resize touch-none items-center justify-center rounded-full border-2 border-ink bg-surface ${FOCUS_RING}`}
    >
